 ...
 */
public class DashScopeTextGenerationClientChatToolCallTest extends KeelInstantRunner {
    ...
    protected Future<Void> run() throws Exception {
        ...
        getLogger().info("=== Step 1: Sending request with tools ===");

        return client.call(request1)
                .compose(response1 -> {
