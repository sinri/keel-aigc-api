...
public class AzureOpenAIChatCompletionsService extends AbstractLLMService {
    private final AzureOpenAIClassicProvider provider;

    public AzureOpenAIChatCompletionsService(AzureOpenAIProviderConfigElement azureOpenAIProviderConfigElement, Logger logger) {
        super(logger);
        this.provider = new AzureOpenAIClassicProvider(azureOpenAIProviderConfigElement, logger);
    }
