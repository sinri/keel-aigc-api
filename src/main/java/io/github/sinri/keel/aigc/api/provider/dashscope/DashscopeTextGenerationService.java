...
import io.github.sinri.keel.aigc.api.llm.sect.dialect.qwen.QwenUtils;
import io.github.sinri.keel.aigc.api.llm.sect.dialect.qwen.request.QwenRequest;
import io.github.sinri.keel.aigc.api.llm.sect.dialect.qwen.response.stream.QwenResponseBuffer;
...
public class DashscopeTextGenerationService extends AbstractLLMService {
    private final DashscopeProvider dashscopeProvider;

    public DashscopeTextGenerationService(String apiKey, Logger logger) {
        super(logger);
